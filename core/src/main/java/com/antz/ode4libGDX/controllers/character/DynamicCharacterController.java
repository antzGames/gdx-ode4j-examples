...
public class DynamicCharacterController {
    ...
    private final OdeEntity character;
    private final OdePhysicsSystem physicsSystem;
    //private final ClosestNotMeRayResultCallback callback;

    public DynamicCharacterController(OdeEntity entity, OdePhysicsSystem odePhysicsSystem) {
        character = entity;
        physicsSystem = odePhysicsSystem;
